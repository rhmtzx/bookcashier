...
<head>
	...
	<title>Kasirku - Halaman Register</title>
							...
							<div class="col-xl-6">
								<div class="card-body p-md-5">
									<div class="text-center">
										...
										<h3 class="mt-4 font-weight-bold"><em>Register Petugas Kasir</em></h3>
									</div>
									<div class="">
										<br>
										<div class="form-body">
											<form action="/prosesregister" method="post" class="row g-3">
												@csrf
												<div class="col-sm-12">
													<label for="inputFirstName" class="form-label">Masukkan Nama</label>
													<input type="text" name="name" class="form-control" id="" placeholder="Muhammad Rahmatullah">
												</div>
												<div class="col-sm-12">
												...
												<div class="col-sm-12">
													<label for="inputFirstName" class="form-label">Masukkan Telepon</label>
													<input type="number" name="telepon" class="form-control" id="telepon" placeholder="089679202034">
												</div>
												<div class="col-12">
